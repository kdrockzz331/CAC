          ...
          <div class="col-lg-12 connectedSortable">
			<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><?php echo $_SESSION["stdname"]; ?> Results</h3>
              ...
              <div class='card-body table-responsive p-0'>
				...
				<div class='card-header'>
				  ...
				  $result = mysqli_query($conn,"SELECT * FROM root WHERE stdid = '$stdid' AND semid = '$stdc'");
				  while($row = mysqli_fetch_array($result)){
						#$per =  ($row['attended']/ $row['conducted'])*100;
						echo "<tr>";
						echo "<td>" . $row['id'] . "</td>";
